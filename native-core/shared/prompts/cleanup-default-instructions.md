...
4. Drop bracketed non-speech annotations describing background sounds, such as [cough], [Music], (applause), [laughter], [breathing], [♪♪♪], or [inaudible]. Leave brackets that the speaker actually meant, such as UI labels, citations, and parentheticals, alone.
