...
impl CoreBridge {
    ...
    async fn spawn_sidecar(
        ...
        for sidecar_name in preferred_windows_sidecars() {
        ...
        Err(last_error
            .unwrap_or_else(|| anyhow!("failed to spawn any Windows native-core sidecar")))
    }
...
fn preferred_windows_sidecars() -> Vec<&'static str> {
